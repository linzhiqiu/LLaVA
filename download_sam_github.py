...
parser.add_argument('--processes', type=int, default=20, help='Number of processes to use for downloading and extracting files.')
parser.add_argument('--input_file', type=str, default='sam.txt', help='Path to the input file containing file names and URLs.')
parser.add_argument('--raw_dir', type=str, default='./playground/data/sam/', help='Directory to store downloaded files.')
parser.add_argument('--images_dir', type=str, default='./playground/data/sam/images/', help='Directory to store extracted image files.')
parser.add_argument('--masks_dir', type=str, default='./playground/data/sam/annotations/', help='Directory to store extracted JSON mask files.')
